...
wandb_project = 'owt'
wandb_run_name = 'TinyStories_2048' # 'run' + str(time.time())
# data
dataset = 'TinyStories'
gradient_accumulation_steps = 48 # used to simulate larger batch sizes
batch_size = 1 # if gradient_accumulation_steps > 1, this is the micro-batch size
block_size = 2048 # maximum number of tokens in a sequence   
# model
n_layer = 12
n_head = 8
n_embd = 512
dropout = 0.00025 # for pretraining 0 is good, for finetuning try 0.1+
...
for i in tqdm(range(max_iters)):
    ...
    if i % eval_interval == 0 and master_process and local_iter_num > 0:
        ...
        with torch.no_grad():
            ...
            for idx_next in model.module.generate_streaming(x, max_new_tokens, temperature=temperature, top_k=top_k):
               ...
               #     generated_sequences.append(generated_text)
                    ...
                    generated_text = ''
                    break
            print(remove_caseifer(actual_output))
